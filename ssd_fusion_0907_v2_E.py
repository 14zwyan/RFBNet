...
'''
    @Comment: Based on experiment, this script delete last two attention module for speeding up 
    @deleted semodule is se4 se3
...
class SSD(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, head, num_classes):
        ...
        self.se0 = Local_Global_Attention_Hybrid_wo_GC(512*3,512,16)
