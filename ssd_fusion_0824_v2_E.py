...
class SSD(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, head, num_classes):
        ...
        self.se0 = Local_Global_Attention_Hybrid(512*3,512,16)
        ...
        self.se1= Local_Global_Attention_Hybrid(1024*3,1024,16)
        ...
        self.se2 = Local_Global_Attention_Hybrid(512*3,512,16)
        ...
        if phase == 'test':
            ...
            #self.detect = RefineDetect(num_classes, 0, 200, 0.01, 0.45)
    ...
    def forward(self, x):
        ...
        [conv3_1_down,conv4_3_bn,fc7_up] = torch.split(conv4_3_bn,512,dim=1)
        ...
        [conv4_1_down,fc7_bn,conv6_2_up] = torch.split(fc7_bn,1024,dim=1)
        ...
        [fc7_down,conv6_2_bn,conv7_2_up] = torch.split(conv6_2_bn,512,dim=1)
        ...
        if self.phase == "test":
            output = (
                ...
                self.softmax1(obj.view(obj.size(0),-1,2))
...
def multibox(vgg, extra_layers, cfg, num_classes):
    ...
    for k, v in enumerate(extra_layers[1::2], 2):
        ...
        obj_layers += [ nn.Conv2d(v.out_channels,cfg[k]*2,kernel_size=3,padding=1) ]
